...
function loadListeners() {
  ...
  futureListeners('dashboard-div', '.prj-btn-delete', 'click', (e) => {
    deletePrjButton(e);
  }); // for the delete buttons in the ToDos
  futureListeners('dashboard-div', '.prj-btn-edit', 'click', (e) => {
    editPrjButton(e);
  }); // for the edit buttons in the ToDos
  ...
  futureListeners('todo-holder', '.card-check', 'click', (e) => {
    checkToDo(e);
  }); // for the edit buttons in the ToDos
  futureListeners('todo-holder', '.btn-delete', 'click', (e) => {
    deleteToDoButton(e);
  }); // for the delete buttons in the ToDos
  futureListeners('todo-holder', '.btn-edit', 'click', (e) => {
    editToDoButton(e);
  }); // for the edit buttons in the ToDos
}
